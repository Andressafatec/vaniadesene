                                    ...
                                    <div class="row">
                                        ...
                                        <div class="tipo">
                                            <div class="form-check">
                                                ...
                                                {{ ucfirst(strtolower($tipoimoveis->tipo)) }}
                                                </label>
                                            </div>
                                        </div>
                                        @endforeach
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="tipo">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="flexCheckDefault1">
                                                    {{ ucfirst(strtolower($finalidadeimoveis->finalidade)) }}
                                ...
                                <div class="col-12 tipo" style="max-width:100%">
                                        @foreach ($cidadeimovel as $cidadeimoveis)
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="flexCheckDefault1">
                                                    {{ ucfirst(strtolower($cidadeimoveis->cidade)) }}
                                ...
                                <div class="col-12 tipo" style="max-width:100%">
                                    <select name="bairro" class="form-control">
                                        ...
                                        @foreach ($bairroimovel as $bairroimoveis)
                                            <option value="{{ $bairroimoveis->bairro }}"> {{ ucfirst(strtolower($bairroimoveis->bairro)) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <!--<div class="col-12">-->
                        ...
                        <div class="pagination left">
                            <ul class="pagination-list">
                                <li><a href="javascript:void(0)" id="paginaAnterior"><i class="fas fa-chevron-left li_icone"></i></a></li>
                                <li><a href="javascript:void(0)" class="paginaNumero">1</a></li>
                                <li class="active"><a href="javascript:void(0)" class="paginaNumero">2</a></li>
                                <li><a href="javascript:void(0)" class="paginaNumero">3</a></li>
                                <li><a href="javascript:void(0)" class="paginaNumero">4</a></li>
                                <li><a href="javascript:void(0)" id="paginaProxima"><i class="fas fa-chevron-right li_icone"></i></a></li>
                            </ul>
                        </div>-->
                        <!--/ End Pagination --><!--
                    </div>-->
