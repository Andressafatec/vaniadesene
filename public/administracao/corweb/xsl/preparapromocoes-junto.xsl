...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:variable name="URL">/corweb/</xsl:variable>
	...
	<xsl:template match="contratos">
		<xsl:element name="div">
			<xsl:attribute name="id">divEnfeite</xsl:attribute>
			<xsl:attribute name="style">background:url(templates/ja_uvite/images/fundo1.jpg);background-repeat:no-repeat;padding:5px;</xsl:attribute>
			<xsl:element name="h3">
