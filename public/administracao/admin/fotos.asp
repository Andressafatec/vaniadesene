...
<%
vCod=LimpaDados(request.QueryString("id_imovel"))
...
<input type="hidden" name="id_imovel" value="<%=vCod%>" />
<br />
...
<div class="foto">
<img src="../imgs/imoveis/<%=rsFoto("arquivo")%>" width="170" height="150" border="0" />
<br />
<a href="alterar-foto.asp?idFoto=<%=rsFoto("id_foto")%>" style="color:#666;">Atualizar</a> | 
<a href="remover-foto.asp?idFoto=<%=rsFoto("id_foto")%>" style="color:#666;">Apagar</a>
</div>
