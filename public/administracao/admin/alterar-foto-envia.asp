...
id_foto = LimpaDados(request.QueryString("id_foto"))
...
altera="update galeria_fotos set arquivo='"& arquivo_nome &"' where id_foto="& id_foto
conn.execute(insere)
...
'Seleciona a foto para recuperar o ID do imovel
sql_verifica_foto="select * from galeria_fotos where id_foto="& id_foto &""
set rsVerificaFoto=conn.execute (sql_verifica_foto)

'Define um valor para id do imovel
id_imovel=rsVerificaFoto("id_imovel")
