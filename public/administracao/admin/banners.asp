...
response.write "<tr'><td align='center' width='100%'>Nenhum cadastro encontrado.</td></tr>"
...
<tr>
	<td align="center" valign="middle"><a href="javascript:if(confirm('Tem certeza que deseja excluir este imóvel?')){location.href='remover-banner.asp?cod=<%=rs("id_banner")%>';}"><img src="images/ic-excluir.png" alt="Excluir" title="Excluir" width="20" height="20" border="0"></a> <a href="alterar-banner.asp?cod=<%=rs("id_banner")%>"><img src="images/ic-alterar.png" alt="Alterar informações" title="Alterar informações" width="20" height="20" border="0"></a></td>
	<td align="center" valign="middle"><%=rs("descricao")%></td>
	<td align="center" valign="middle"><%=rs("arquivo")%></td>
	</tr>
