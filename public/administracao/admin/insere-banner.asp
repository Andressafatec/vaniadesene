...
<h1>Informações do Banner</h1>

<div class="defaultForm">

<form name="bannerInsere" action="insere-banner-envia.asp" method="post" enctype="multipart/form-data" onSubmit="return validaInsereBanner()">
