...
sql_foto="select * from galeria_fotos where id_foto="& id_foto &""
set rsFoto=conn.execute(sql_foto)
...
<form name="fotoAltera" action="alterar-foto-envia.asp?id_foto=<%=id_foto%>" method="post" onSubmit="return validaAlteraFoto()" enctype="multipart/form-data">
...
<input name="enviar" type="submit" id="enviar" value="Alterar foto" />
