...
<head>
	...
	<title animated fadeIn>Vania de Sene</title>
	...
	<main class="main-wrapper side-collapse-container">
		...
		<div class="main-navbar-vania">
				...
				<div class="row">
					...
					<div class="col-sm-6  hidden-xs"><a class="logo animated flipInY " href="#"><img src="{{asset('/min/img/logo.png')}}" class="img-responsive"></a></div>
					<div class="col-sm-3 col-xs-6">
