...
<table widtd="100%" border="0" align="center" cellpadding="5" cellspacing="0" style="max-width:500px; width:100%; margin:0 auto; background:#fff; font-family:sans-serif;">
  ...
  <tr>
    <td colspan="2" align="center" ><a href="http://vaniadesene.com.br/detalhes/{{$imovel[0]->referencia}}" style="background:#F90; color:#fff; display:inline-block; text-decoration:none; padding:20px;"><strong>VER IMÓVEL NO SITE</strong></a> </td>
  </tr>
</table>