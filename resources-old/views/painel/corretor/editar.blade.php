...
<form action="{{ route('admin.corretor.update',$corretor->id) }}" method="POST">
    @csrf
    @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type='text' name="creci" class="form-control" value="{{ $corretor->creci }}">
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group">
                        {!! Form::label('email','E-mail:') !!}
                        <input type='text' name="email" class="form-control" value="{{ $corretor->email }}">
                    </div>
                </div>
                <div class="col-12">
                    <div class="col-12">
                    ...
                    <div class="col-6 text-center borda">
                        <div class="imagens">
                            <div class="col-12">
                                <div>
                                <div class="containerUpload pt-0">
                                    <img src="{{ asset('upload/corretor/'.$corretor->foto) }}" alt="" style="">
